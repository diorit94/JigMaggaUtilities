...
var extendApiCallsWithModels = function (config) {
    ...
    config.jigs = _.reduce(jigs, function (currentResult, jig, jigName) {
        currentResult[jigName] = jig;
        if (jig.models) {
            currentResult[jigName].apicalls = extendApiCalls(currentResult[jigName].apicalls, jig.models, models);
        }
